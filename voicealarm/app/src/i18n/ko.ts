...
export const ko = {
  ...
  'home.newAlarm': '알람 보내기',
  'home.cancelAlarm': '취소',
  'home.cancelAlarm.confirm': '{name} 님에게 보낸 알람을 취소할까요?',

  'alarm.status.scheduled': '예약됨',
  'alarm.status.delivered': '울림',
  'alarm.status.cancelled': '취소됨',
  'alarm.status.blocked': '차단됨',
  'alarm.status.failed': '실패',
  'alarm.sent.title': '알람을 보냈습니다',
  'alarm.sent.body': '{name} 님에게 지정한 시각에 알람이 울립니다.',

  'createAlarm.title': '알람 보내기',
  'createAlarm.friend': '받을 사람',
  'createAlarm.time': '알람 시각',
  'createAlarm.timezone': '기기 타임존: {timezone}',
  'createAlarm.tooSoon': '너무 임박한 시각입니다. 최소 몇 분 뒤로 설정해 주세요.',
  'createAlarm.next': '다음: 녹음하기',
  ...
  'record.title': '녹음',
  'record.titleForAlarm': '메시지 녹음',
  'record.start': '녹음 시작',
  'record.stop': '녹음 중지',
  'record.play': '들어보기',
  'record.pause': '일시정지',
  'record.upload': '이 녹음 사용하기',
  'record.uploaded': '업로드 완료',
  'record.sendAlarm': '{name} 님에게 보내기',
  'record.rerecord': '다시 녹음',
  'record.hint': '버튼을 눌러 녹음을 시작하고, 다시 눌러 멈춥니다.',
  'record.limit': '최대 {seconds}초',
  'record.remaining': '{seconds}초 남음',
  'record.error.permission': '마이크 권한이 필요합니다. 설정에서 허용해 주세요.',
  'record.error.tooShort': '녹음이 너무 짧습니다.',
  'record.error.failed': '녹음에 실패했습니다. 다시 시도해 주세요.',
